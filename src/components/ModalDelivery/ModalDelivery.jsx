...
import {closeModal} from "../../store/modalDelivery/modalDeliverySlce.js";
            ...
            <form className={style.form} id='delivery' onSubmit={handleSubmit}>
              <fieldset className={style.fieldset}>
                <input
                    ...
                    name='name'
                    value={form.name}
                    placeholder='Ваше имя' onChange={handleInputChange}
                />
                <input
                    className={style.input}
                    type='tel'
                    name='phone'
                    value={form.phone}
                    placeholder='Телефон' onChange={handleInputChange}
                />
              </fieldset>
              ...
              <fieldset className={style.fieldset_radio}>
                <label className={style.label}>
                  <input
                      ...
                      name='format'
                      value='pickup'
                      checked={form.format === 'pickup'} onChange={handleInputChange}
                  />
                  <span>Самовывоз</span>
                </label>
                ...
                <label className={style.label}>
                  <input
                      ...
                      name='format'
                      value='delivery'
                      checked={form.format === 'delivery'} onChange={handleInputChange}
                  />
                  <span>Доставка</span>
                </label>
              </fieldset>
              ...
              {form.format === 'delivery' && (
                  <fieldset className={style.fieldset}>
                    <input
                        ...
                        name='address'
                        value={form.address}
                        placeholder='Улица, дом, квартира' onChange={handleInputChange}
                    />
                    <input
                        ...
                        name='floor'
                        value={form.floor}
                        placeholder='Этаж' onChange={handleInputChange}
                    />
                    <input
                        className={classNames(style.input, style.input_half)}
                        type='number'
                        name='intercom'
                        value={form.intercom}
                        placeholder='Домофон' onChange={handleInputChange}
                    />
                  </fieldset>
              )}
            </form>
